...
public class SettingsFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        int prefLength = prefScreen.getPreferenceCount();

        for (int i = 0; i< prefLength;i++){
            Preference p = prefScreen.getPreference(i);
            if(!(p instanceof CheckBoxPreference)){
                String value = sharedPreferences.getString(p.getKey(),"");
                SetPrefereneceSummary(p,value);
            }
        }
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        ...
        if(null != preference){
            if(!(preference instanceof CheckBoxPreference)){
                ...
                SetPrefereneceSummary(preference,value);
            }
        }
    }
    ...
    public void SetPrefereneceSummary(Preference preference,String value){
